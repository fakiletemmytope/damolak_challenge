...
def get_token(payload: dict[str, Any], token_type: TOKEN_TYPE = TOKEN_TYPE.ACCESS) -> str:
    to_encode = payload.copy()
    if token_type == TOKEN_TYPE.ACCESS:
        to_encode["exp"] = datetime.now(tz=timezone.utc) + timedelta(minutes=30)
